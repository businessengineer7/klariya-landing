...
const PartyNova = ({ t }: { t: TFunction }) => {
  return (
    <PartySection id="party">
      <Fade direction="up" triggerOnce>
        <PartyTitle>{t("Nova en action")}</PartyTitle>
        <DanceFloor>
          <DiscoLights />
          ...
          <svg width="350" height="350" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" style={{ position: "relative", zIndex: 10 }}>
            <defs>
              <linearGradient id="partyGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#2563EB">
                  <animate attributeName="stop-color" values="#2563EB;#3B82F6;#10B981;#2563EB" dur="1s" repeatCount="indefinite" />
                </stop>
                <stop offset="100%" stopColor="#10B981">
                  <animate attributeName="stop-color" values="#10B981;#2563EB;#3B82F6;#10B981" dur="1s" repeatCount="indefinite" />
                </stop>
              </linearGradient>
            ...
            {/* Shockwave at feet */}
            <ellipse cx="100" cy="160" rx="40" ry="10" fill="none" stroke="#2563EB" strokeWidth="2" opacity="0">
